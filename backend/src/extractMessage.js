...
- macros.calories: food intake / eaten (kcal). caloriesBurned: total energy burned that day — resting + active combined (kcal out). This is the full TDEE figure. If the user only mentions active/exercise calories, add an estimated resting burn (~1700 kcal for an average adult) to get the total. If the user only gives net or TDEE, put intake in macros.calories and estimate or null for burned unless stated.
